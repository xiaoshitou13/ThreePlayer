...
public class FindFragment extends BaseFragment {
    ...
    private void initData() {
        ...
        CardItemTouchHelperCallback cardCallback = new CardItemTouchHelperCallback(recyclers.getAdapter(), list);
        cardCallback.setOnSwipedListener(new OnSwipeListener<FindBean>() {
            @Override
            ...
            @Override
            public void onSwiped(RecyclerView.ViewHolder viewHolder, FindBean mybean, int direction) {
                MyAdapters.MyHolder myHolder = (MyAdapters.MyHolder) viewHolder;
