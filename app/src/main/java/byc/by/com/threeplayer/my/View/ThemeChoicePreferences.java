...
/**
 * Created by 白玉春 on 2017/12/11.
 */

public class ThemeChoicePreferences extends DialogPreference {
    ...
    public ThemeChoicePreferences(final Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        View view= LayoutInflater.from(Utils.context).inflate( R.layout.dialog_theme_choice,null);
